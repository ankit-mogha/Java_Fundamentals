...
public class MainClass {
  public static void main(String[] args) {
    ...
    // Question 2
    System.out.println(
        "Number at the given index of Fibonacci Series is : "
    ...
    // Question 8
    System.out.println(
        "List of substrings of given size : " + SubStringOfKSize.subStringOfString("ankit", 2));
    // Question 9
    Address.listOfCities();
    // Question 10
